!function(e) {
    ...
    var t, n, i, o, a, r, s = "Close", l = "BeforeClose", c = "AfterClose", d = "BeforeAppend", u = "MarkupParse", p = "Open", f = "Change", m = "mfp", g = "." + m, h = "mfp-ready", v = "mfp-removing", C = "mfp-prevent-close", y = function() {}, b = !!window.jQuery, w = e(window), I = function(e, n) {
        t.ev.on(m + e + g, n)
    }, x = function(t, n, i, o) {
    ...
    y.prototype = {
        ...
        open: function(n) {
            ...
            a += " mfp-close-btn-in") : t.wrap.append(T())),
            ...
            t.st.blackbg ? t.bgOverlay.addClass("mfp-black-bg") : "",
            t.st.whitebg ? t.bgOverlay.addClass("mfp-white-bg") : "";
        ...
        _close: function() {
            ...
            t.bgOverlay.attr("class", "mfp-bg").removeClass("mfp-black-bg"),
    ...
    ;
    var S, P, O, z = "inline", M = function() {
        O && (P.after(O.addClass(S)).detach(),
        O = null)
    };
    ...
    var R = "iframe"
      ...
      , q = function(e) {
        if (t.currTemplate[R]) {
            ...
            n.length && (e || (n[0].src = Z),
            t.isIE8 && n.css("display", e ? "block" : "none"))
        }
    };
    e.magnificPopup.registerModule(R, {
        options: {
            markup: '<div class="mfp-iframe-scaler"><div class="mfp-close"></div><iframe class="mfp-iframe" src="//about:blank" frameallowfullscreen></iframe></div>',
    ...
    e.magnificPopup.registerModule("gallery", {
        ...
        proto: {
            initGallery: function() {
                ...
                I(u + o, function(e, i, o, a) {
                    var r = t.items.length;
                    o.counter = r > 1 ? K(n.tCounter, a.index, r) : ""
                }),
                I("BuildControls" + o, function() {
                    if (t.items.length > 1 && n.arrows && !t.arrowLeft) {
                        var i = n.arrowMarkup
                          , o = t.arrowLeft = e(i.replace(/%title%/gi, n.tPrev).replace(/%dir%/gi, "left")).addClass(C)
                          , a = t.arrowRight = e(i.replace(/%title%/gi, n.tNext).replace(/%dir%/gi, "right")).addClass(C)
            ...
            initRetina: function() {
                if (window.devicePixelRatio > 1) {
                    var e = t.st.retina
                      , n = e.ratio;
                    n = isNaN(n) ? n() : n,
                    n > 1 && (I("ImageHasSize." + Y, function(e, t) {
                        t.img.css({
    ...
    function() {
        ...
        e.fn.destroyMfpFastClick = function() {
            ...
            n && w.off("touchmove" + a + " touchend" + a)
        }
    }(),
    E()
});
