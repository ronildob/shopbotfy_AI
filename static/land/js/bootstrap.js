...
+function ($) {
    ...
    Collapse.prototype.toggle = function () {
        var isTouchDevice = "ontouchstart" in window || navigator.msMaxTouchPoints; if (isTouchDevice)
            this[this.$element.hasClass('in') ? 'hide' : 'show']()
        else {
            if (this.$element.parent().parent().hasClass("navbar-nav")) { if ($('.navbar-toggle').is(":visible")) { this[this.$element.hasClass('in') ? 'hide' : 'show']() } }
